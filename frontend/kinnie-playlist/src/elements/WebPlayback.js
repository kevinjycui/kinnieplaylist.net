            ...
            <div className="container WebPlayback-player">
                <div className="main-wrapper">
                    ...
                    <div className="WebPlayback-spotify">
                        Remote control with <a href="https://open.spotify.com/" target="_blank" rel="noreferrer"><img className="WebPlayback-spotifyLogo" alt='Spotify logo' src='/spotify-icons-logos/logos/01_RGB/02_PNG/Spotify_Logo_RGB_Green.png' /></a>
                    </div>
                </div>
            </div>
        </> : (
